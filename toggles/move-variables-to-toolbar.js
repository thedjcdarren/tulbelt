...
(() => {
  ...
  const TOOLBAR_ANCHOR_SELECTORS = ["#app-editor-translation", "#app-editor-snapshot"];
  const TRANSLATION_DROPDOWN_SELECTOR = '[data-testid="translationTargetLocalDropdown"]';
